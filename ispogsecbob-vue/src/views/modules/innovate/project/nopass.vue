<template>
  <div class="mod-user">
    ...
    <el-card>
      <el-radio-group v-model="noPass" @change="getDataList">
        <el-radio label="audit_no_pass">大创不通过</el-radio>
        <el-radio label="base_no_pass">基地不通过</el-radio>
        <el-radio label="match_no_pass">比赛不通过</el-radio>
        <el-radio label="finish_no_pass">结题不通过</el-radio>
      </el-radio-group>
    </el-card>
    <el-table
      :data="dataList"
