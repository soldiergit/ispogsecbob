  ...
  <div class="mod-user">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('innovate:cost:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('innovate:cost:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button v-if="isAuth('innovate:cost:update')" type="text" size="small" @click="addOrUpdateHandle(scope.row.costId)">修改</el-button>
          <el-button v-if="isAuth('innovate:cost:delete')" type="text" size="small" @click="deleteHandle(scope.row.costId)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
