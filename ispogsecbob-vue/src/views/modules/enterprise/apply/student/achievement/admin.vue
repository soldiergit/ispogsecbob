  ...
  <div class="mod-config">
    ...
    <el-table
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button v-if="passVisible(scope.row)" type="text" size="small" @click="applySubmitHandle(scope.row.stuAchievementId,2)">通过</el-button>
          <el-button v-if="noPassVisible(scope.row)" type="text" size="small" @click="retreatHandle(scope.row.stuAchievementId)">不通过</el-button>
