    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button v-if="submitVisiableHandle(scope.row)" type="text" size="small" @click="submitHandle(scope.row.teaExperienceId)">提交</el-button>
          <el-button v-if="updateVisiableHandle(scope.row)" type="text" size="small" @click="addOrUpdateHandle(scope.row.teaExperienceId)">修改</el-button>
          <el-button v-if="deleteVisiableHandle(scope.row)" type="text" size="small" @click="deleteHandle(scope.row.teaExperienceId)">删除</el-button>
