package io.ispogsecbob.utils;

import io.ispogsecbob.config.MongoManager;
import io.ispogsecbob.entity.ColumnEntity;
import io.ispogsecbob.entity.TableEntity;
import io.ispogsecbob.entity.mongo.MongoDefinition;
import io.ispogsecbob.entity.mongo.MongoGeneratorEntity;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "io.ispogsecbob" : mainPath;
        //封装模板数据
