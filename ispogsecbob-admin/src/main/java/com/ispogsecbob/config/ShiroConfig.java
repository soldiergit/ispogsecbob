...
import com.ispogsecbob.modules.sys.oauth2.OAuth2Filter;
import com.ispogsecbob.modules.sys.oauth2.OAuth2Realm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        filterMap.put("/ispogsecbob/sys/institute/all", "anon");
        filterMap.put("/ispogsecbob/sys/grade/all", "anon");
        filterMap.put("/ispogsecbob/sys/school/all", "anon");
        filterMap.put("/ispogsecbob/sys/subject/all", "anon");
